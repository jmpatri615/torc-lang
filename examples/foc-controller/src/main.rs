...
//! using the Torc GraphBuilder API, then scaffolds a complete Torc project
//! directory with `torc.toml`, `graph/main.trc`, and `.gitignore`.
//!
//! Usage:
